...
function ContatoPage() {
  ...
  return (
    <div className="contato-page">
      ...
      {/* Hero */}
      <section className="contato-page-hero">
        <div className="contato-page-hero-container">
          <div className="contato-hero-label">Fale Conosco</div>
          <h1>Solicite seu<br />Orçamento</h1>
          <p className="contato-hero-subtitle">
            Transforme seus ambientes com móveis sob medida de verdadeiro alto padrão.
            Nossa equipe está pronta para criar o projeto exclusivo que você sempre desejou.
          </p>
        </div>
      </section>

      {/* Conteúdo */}
      <section className="contato-page-content">
