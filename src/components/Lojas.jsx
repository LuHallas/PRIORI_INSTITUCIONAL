    ...
    <section className="lojas" id="lojas">
      <div className="lojas-container">
        ...
        <div className="lojas-grid">
          ...
          <div className="loja-card">
            ...
            <div className="loja-content">
              ...
              <div className="loja-info">
                ...
                <div className="loja-info-item">Cotia - SP, 06711-270</div>
          ...
          {/* Loja 2 - Em Breve */}
          <div className="loja-card loja-card-breve">
            <div className="loja-mapa-topo">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3656.255!2d-46.8527537!3d-23.6041782!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cf03d3e2e3b7a5%3A0x1234567890!2sR.%20Tom%C3%A1s%20Sep%C3%A9%2C%20240%20-%20Jardim%20da%20Gloria%2C%20Cotia%20-%20SP%2C%2006711-270!5e0!3m2!1spt-BR!2sbr!4v1234567890"
                width="100%"
                ...
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Mapa Loja São Paulo"
              ></iframe>
            </div>
            <div className="loja-content">
              <h3>São Paulo - Pompeia</h3>
              <div className="loja-info">
                <div className="loja-info-item">Av. Pompéia, 1001 - Pompeia</div>
                <div className="loja-info-item">São Paulo - SP, 05023-000</div>
                <div className="loja-info-item">📞 (11) 97637-2670</div>
                <div className="loja-info-item">🕐 Seg a Sex: 10h às 19h</div>
                <div className="loja-info-item">🕐 Sáb: 10h às 16h</div>
              </div>
          ...
          <div className="loja-card">
            <div className="loja-mapa-topo">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3659.123!2d-45.8963!3d-23.2205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cc4a1b2c3d4e5f%3A0xabcdef1234567890!2sAv.+Cassiano+Ricardo%2C+601+-+Jardim+Aquarius%2C+S%C3%A3o+Jos%C3%A9+dos+Campos+-+SP!5e0!3m2!1spt-BR!2sbr!4v1234567890"
                width="100%"
                height="250"
                style={{ border: 0 }}
                allowFullScreen=""
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Mapa Escritório São José dos Campos"
              ></iframe>
            </div>
            <div className="loja-content">
              <h3>Escritório — São José dos Campos</h3>
              <div className="loja-info">
                <div className="loja-info-item">The One Office Tower</div>
                <div className="loja-info-item">Av. Cassiano Ricardo, 601 - Jardim Aquarius</div>
                <div className="loja-info-item">São José dos Campos - SP, 12246-870</div>
                <div className="loja-info-item">📞 (11) 97637-2670</div>
                <div className="loja-info-item">🕐 Seg a Sex: 9h às 18h</div>
              </div>
              <a
                href="https://www.google.com/maps/search/?api=1&query=Av.+Cassiano+Ricardo,+601+-+Jardim+Aquarius,+São+José+dos+Campos+-+SP,+12246-870"
                target="_blank"
                rel="noopener noreferrer"
                className="loja-link"
              >
